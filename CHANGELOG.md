...
## 1.14.0.108 - 2021-12-25 - 完成skill

### Added:
- behavior新增import功能，使腳本能夠重複使用。
- behavior新增父類參數繼承功能，當參數使用「$ + 索引」時，系統會去讀取父類參數於該索引的值。

## 1.13.0.106 - 2021-12-19
>>>>>>> 58aeb21edb7afb46ee2b9a53dfb1071096dfde02
### Added:
- **[shared]** 新增數值公式，在計算傷害等效果時會用到。
- **[std]** 新增json.lua，處理之後一些模組的靜態數值。
- 新增效果管理器，統一管理指定對象所有的遊戲效果。
